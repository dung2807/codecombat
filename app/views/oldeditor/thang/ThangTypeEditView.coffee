require('app/styles/oldeditor/thang/thang-type-edit-view.sass')
...
ThangComponentsEditView = require 'views/oldeditor/component/ThangComponentsEditView'
...
VectorIconSetupModal = require 'views/oldeditor/thang/VectorIconSetupModal'
SaveVersionModal = require 'views/oldeditor/modal/SaveVersionModal'
template = require 'templates/oldeditor/thang/thang-type-edit-view'
...
#    @$el.find('#upload-button').prop('disabled', true)
  ...
  saveNewThangType: (e) ->
    ...
    res.success =>
      url = "/oldeditor/thang/#{newThangType.get('slug') or newThangType.id}"
      portraitSource = null

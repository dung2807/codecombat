require('app/styles/oldeditor/poll/poll-edit-view.sass')
RootView = require 'views/core/RootView'
template = require 'templates/oldeditor/poll/poll-edit-view'
...
module.exports = class PollEditView extends RootView
  ...
  savePoll: (e) ->
    ...
    res.success =>
      url = "/oldeditor/poll/#{@poll.get('slug') or @poll.id}"
    ...
    $.ajax
      ...
      success: ->
        noty
          ...
          layout: 'topCenter'
        _.delay ->
          application.router.navigate '/oldeditor/poll', trigger: true
        , 500

require('app/styles/oldeditor/level/system/add.sass')
ModalView = require 'views/core/ModalView'
template = require 'templates/oldeditor/level/system/add'
availableSystemTemplate = require 'templates/oldeditor/level/system/available_system'

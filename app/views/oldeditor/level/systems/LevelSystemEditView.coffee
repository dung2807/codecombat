require('app/styles/oldeditor/level/system/level-system-edit-view.sass')
CocoView = require 'views/core/CocoView'
template = require 'templates/oldeditor/level/system/level-system-edit-view'
LevelSystem = require 'models/LevelSystem'
SystemVersionsModal = require 'views/oldeditor/level/systems/SystemVersionsModal'

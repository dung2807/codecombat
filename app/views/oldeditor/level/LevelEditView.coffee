require('app/styles/oldeditor/level/documentation_tab.sass')
RootView = require 'views/core/RootView'
template = require 'templates/oldeditor/level/level-edit-view'
...
GenerateTerrainModal = require 'views/oldeditor/level/modals/GenerateTerrainModal'
...
ForkModal = require 'views/oldeditor/ForkModal'
SaveVersionModal = require 'views/oldeditor/modal/SaveVersionModal'
SaveBranchModal = require 'views/oldeditor/level/modals/SaveBranchModal'
LoadBranchModal = require 'views/oldeditor/level/modals/LoadBranchModal'
PatchesView = require 'views/oldeditor/PatchesView'
RelatedAchievementsView = require 'views/oldeditor/level/RelatedAchievementsView'
VersionHistoryView = require './modals/LevelVersionsModal'
ComponentsDocumentationView = require 'views/oldeditor/docs/ComponentsDocumentationView'
SystemsDocumentationView = require 'views/oldeditor/docs/SystemsDocumentationView'
LevelFeedbackView = require 'views/oldeditor/level/LevelFeedbackView'
...
module.exports = class LevelEditView extends RootView
  ...
  events:
    ...
    'click [data-toggle="coco-modal"][data-target="oldeditor/level/modals/GenerateTerrainModal"]': 'openGenerateTerrainModal'

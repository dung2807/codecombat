NewModelModal = require 'views/oldeditor/modal/NewModelModal'
template = require 'templates/oldeditor/level/modal/new-achievement'
...
module.exports = class NewAchievementModal extends NewModelModal
  ...
  onAchievementSubmitted: (e) ->
    ...
    url = "/oldeditor/achievement/#{slug}"

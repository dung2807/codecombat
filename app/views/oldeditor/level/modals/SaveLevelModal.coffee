...
template = require 'templates/oldeditor/level/save-level-modal'
forms = require 'core/forms'
LevelComponent = require 'models/LevelComponent'
LevelSystem = require 'models/LevelSystem'
DeltaView = require 'views/oldeditor/DeltaView'
PatchModal = require 'views/oldeditor/PatchModal'
deltasLib = require 'core/deltas'
VerifierTest = require 'views/oldeditor/verifier/VerifierTest'
      ...
      do (newModel, form) =>
        ...
        res.success =>
          ...
          unless modelsToSave.length
            url = "/oldeditor/level/#{@level.get('slug') or @level.id}"

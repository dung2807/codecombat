require('app/styles/oldeditor/level/modal/artisan-guide-modal.sass')
ModalView = require 'views/core/ModalView'
template = require 'templates/oldeditor/level/modal/artisan-guide-modal'
...
module.exports = class ArtisanGuideModal extends ModalView
  ...
  levelSubmit: ->
    ...
    contactMessage = {message:"""User Name: #{results.creditName}
      Level: <a href="http://codecombat.com/oldeditor/level/#{@options.levelSlug}">#{@options.level}</a>

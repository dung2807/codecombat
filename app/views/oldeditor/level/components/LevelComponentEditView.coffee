require('app/styles/oldeditor/level/component/level-component-edit-view.sass')
CocoView = require 'views/core/CocoView'
template = require 'templates/oldeditor/level/component/level-component-edit-view'
LevelComponent = require 'models/LevelComponent'
ComponentVersionsModal = require 'views/oldeditor/component/ComponentVersionsModal'

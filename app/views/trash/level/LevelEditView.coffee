require('app/styles/editor2/level/documentation_tab.sass')
RootView = require 'views/core/RootView'
template = require 'templates/editor2/level/level-edit-view'
...
GenerateTerrainModal = require 'views/editor2/level/modals/GenerateTerrainModal'
...
ForkModal = require 'views/editor2/ForkModal'
SaveVersionModal = require 'views/editor2/modal/SaveVersionModal'
SaveBranchModal = require 'views/editor2/level/modals/SaveBranchModal'
LoadBranchModal = require 'views/editor2/level/modals/LoadBranchModal'
PatchesView = require 'views/editor2/PatchesView'
RelatedAchievementsView = require 'views/editor2/level/RelatedAchievementsView'
VersionHistoryView = require './modals/LevelVersionsModal'
ComponentsDocumentationView = require 'views/editor2/docs/ComponentsDocumentationView'
SystemsDocumentationView = require 'views/editor2/docs/SystemsDocumentationView'
LevelFeedbackView = require 'views/editor2/level/LevelFeedbackView'
...
module.exports = class LevelEditView extends RootView
  ...
  events:
    ...
    'click [data-toggle="coco-modal"][data-target="editor2/level/modals/GenerateTerrainModal"]': 'openGenerateTerrainModal'

...
module.exports = class CocoRouter extends Backbone.Router
  ...
  routes:
    ...
    'demo': go('CommunityView')
    'demo/level': go('editor/level/LevelSearchView')
    'demo/level/:levelID': go('editor/level/LevelEditView')
    'demo/campaign': go('editor/campaign/CampaignSearchView')
    'demo/campaign/:campaignID': go('editor/campaign/CampaignEditorView')

    'demo': go('CommunityView')

    'demo/achievement': go('editor/achievement/AchievementSearchView')
    'demo/achievement/:articleID': go('editor/achievement/AchievementEditView')
    'demo/article': go('editor/article/ArticleSearchView')
    'demo/article/preview': go('editor/article/ArticlePreviewView')
    'demo/article/:articleID': go('editor/article/ArticleEditView')
    'demo/level': go('editor/level/LevelSearchView')
    'demo/level/:levelID': go('editor/level/LevelEditView')
    'demo/thang': go('editor/thang/ThangTypeSearchView')
    'demo/thang/:thangID': go('editor/thang/ThangTypeEditView')
    'demo/campaign': go('editor/campaign/CampaignSearchView')
    'demo/campaign/:campaignID': go('editor/campaign/CampaignEditorView')
    ...
    'demo/course': go('editor/course/CourseSearchView')
    'demo/course/:courseID': go('editor/course/CourseEditView')

    # 'oldeditor': go('CommunityView')

    # 'oldeditor/achievement': go('oldeditor/achievement/AchievementSearchView')
    # 'oldeditor/achievement/:articleID': go('oldeditor/achievement/AchievementEditView')
    # 'oldeditor/article': go('oldeditor/article/ArticleSearchView')
    # 'oldeditor/article/preview': go('oldeditor/article/ArticlePreviewView')
    # 'oldeditor/article/:articleID': go('oldeditor/article/ArticleEditView')
    # 'oldeditor/level': go('oldeditor/level/LevelSearchView')
    # 'oldeditor/level/:levelID': go('oldeditor/level/LevelEditView')
    # 'oldeditor/thang': go('oldeditor/thang/ThangTypeSearchView')
    # 'oldeditor/thang/:thangID': go('oldeditor/thang/ThangTypeEditView')
    # 'oldeditor/campaign/:campaignID': go('oldeditor/campaign/CampaignEditorView')
    # 'oldeditor/poll': go('oldeditor/poll/PollSearchView')
    # 'oldeditor/poll/:articleID': go('oldeditor/poll/PollEditView')
    # 'oldeditor/verifier': go('oldeditor/verifier/VerifierView')
    # 'oldeditor/verifier/:levelID': go('oldeditor/verifier/VerifierView')
    # 'oldeditor/i18n-verifier/:levelID': go('oldeditor/verifier/i18nVerifierView')
    # 'oldeditor/i18n-verifier': go('oldeditor/verifier/i18nVerifierView')
    # 'oldeditor/course': go('oldeditor/course/CourseSearchView')
    # 'oldeditor/course/:courseID': go('oldeditor/course/CourseEditView')
